...
### 💻 [Cipher Code Editor](https://github.com/Rmatix/cipher)
> Editor de código open source · Electron + Monaco Editor · Windows

Un editor diseñado para el futuro del desarrollo. Integra un agente de IA multi-modelo compatible con **Claude, GPT, Gemini** y modelos locales vía **Ollama / LM Studio**. Cuenta con memoria persistente, Git integrado y un debugger asistido por IA.

`Electron` `Monaco Editor` `Node.js` `xterm.js` `node-pty` `Open Source`
...
`Game Dev` `Dirección de Arte` `Producción Independiente`
...
| Área | Detalle |
|---|---|
| 🤖 **Agentic AI & IA Local** | Configuración de entornos con modelos 7-8B (Qwen, Gemma) vía Ollama y flujos autónomos en editores de código |
...
Construido con un enfoque **ligero y de alto rendimiento**, sin frameworks pesados, para demostrar dominio sobre los fundamentos web:
...
| Canal | Enlace |
|---|---|
| 📺 Canal Principal (Programación) | [@rmatixyt](https://youtube.com/@rmatixyt) |
| 🎧 Canal del Estudio | [@voxmatrixstudios](https://youtube.com/@voxmatrixstudios) |
| 🐙 GitHub | [@Rmatix](https://github.com/Rmatix) |
| ✉️ Email Personal | rayhanmatteo12@gmail.com |
| 💼 Email Business | rmatixbusiness@gmail.com |
| 💬 WhatsApp | [+57 323 8229839](https://wa.me/573238229839) |
